...
import { dummyAboutUs } from '../../mocks/data';
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="bg-accent py-20 border-b border-border-color overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl font-bold text-text-main mb-6">{dummyAboutUs.title}</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              {dummyAboutUs.coreValues.map((value, index) => (
